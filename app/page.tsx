    ...
    <div className="paper-grain relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-[var(--background)] font-[family-name:var(--font-geist-sans)]">
      ...
      <main className="relative z-10 flex w-full max-w-5xl flex-col items-center gap-14 px-6 py-16 sm:py-24">
        ...
        <div className="flex flex-col items-center gap-5">
          ...
          <h1
            className="animate-fade-in-up delay-100 text-center text-6xl font-bold tracking-tight text-[var(--ink)] sm:text-8xl"
        ...
        <div className="flex w-full flex-col items-center gap-8 lg:flex-row lg:items-start lg:justify-center lg:gap-0">
          {/* ASCII Tactical Map */}
          <div
            className="animate-fade-in delay-300 relative rounded-sm border border-[var(--grid-line)] bg-[var(--paper)] p-5 shadow-[2px_3px_8px_rgba(0,0,0,0.08)]"
            style={{ transform: "rotate(-0.8deg)" }}
          >
            {/* Tape pieces */}
            <div
              className="absolute -top-2 left-8 h-5 w-16 rounded-sm bg-[#e8dcc8]/80 shadow-sm"
              style={{ transform: "rotate(-2deg)" }}
            />
            <div
              className="absolute -top-2 right-10 h-5 w-12 rounded-sm bg-[#e8dcc8]/80 shadow-sm"
              ...
              {MAP_LINES.map((line, i) => (
                <div
                  ...
                  style={{
                    ...
                    transform:
                      i < visibleMapLines ? "translateX(0)" : "translateX(-8px)",
                  }}
                >
          ...
          >
            ...
            <div className="flex flex-col gap-2 font-[family-name:var(--font-geist-mono)] text-[12px] leading-relaxed">
              {STRAT_LINES.map((line, i) => {
                ...
                if (line.style === "title") {
                  className +=
                    " font-bold text-[var(--ink)] text-sm border-b border-[var(--ink)]/20 pb-1 mb-1";
                }
                if (line.style === "red") {
                ...
                if (line.style === "underline") {
                  className +=
                    " underline decoration-[var(--pencil)] decoration-wavy decoration-1 underline-offset-4 text-[var(--ink-light)] text-[11px] mt-2";
                }
